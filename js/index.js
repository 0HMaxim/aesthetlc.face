...
function header_refresh(header_menuArr, newLang, oldLang) {
    ...
    <div class="fixed row my_container">
                ...
                <div class="header_top_row d-flex justify-content-between align-items-center">
                    ...
                    <div class="logo_block d-flex justify-content-center">
                        ...
                        <a href="${countPoin}index.html" class="d-flex align-items-center header_logo">
                        ...
                        <div class="d-flex align-items-center icon_block justify-content-center">
                            ...
                            <div class="details d-flex row">
                                    <p class="">Poggendörper Weg 3-9, 24149 Kiel</p>
                                    <a href="tel:+491605122398" class="fw600 " >+49 (160) 512 2398</a>
                            </div>
                    ...
                    <div class="d-flex align-items-center icon_block ">

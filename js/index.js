...
function renderGalleryItem(item, index) {
    ...
    if (item.imgUrl && item.imgUrl.length > 0) {
        ...
        content += `<p class="total"><b>${item.imgUrl.length+1}</b> фото</p>`

        console.log(item.title)
        console.log(item.imgUrl.length)
...
<footer>
            <div class="my_container footer  justify-content-between">
                ...
                <div class="logo_col">
                    ...
                    <p class="col_title fw500">Ми в соціальних мережах:</p>
                    ...
                    <div class="d-flex align-items-center ">
                        ...
                        <div class="icon_block d-flex align-items-center messengers ">
                                        ...
                                        <a href="https://web.telegram.org/k/#@beautifulinjections" class="d-flex tg" target="_blank">
                                            <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M22.8966 3.81554L19.8663 20.493C19.5372 22.3416 18.4439 23 17.53 23C17.0585 23 16.569 22.8386 16.0738 22.5191L15.9915 22.4653L15.9146 22.3995L9.61325 16.9633L9.37642 20.1402C9.2528 20.8824 8.66198 21.4155 7.98958 21.3522C7.47279 21.3033 7.05375 20.9169 6.87874 20.3994L5.82719 16.7912C5.77904 16.6803 5.74993 16.5588 5.74993 16.4286C5.74993 15.9747 6.07157 15.6071 6.46868 15.6071C6.78242 15.6071 7.04549 15.8371 7.14396 16.1567C7.14468 16.1567 7.14576 16.1559 7.14647 16.1546L8.0097 19.1179L8.1362 17.4221C8.1362 17.42 8.1362 17.42 8.1362 17.4192C8.21455 16.3329 9.04831 15.5246 9.99887 15.6137C10.3126 15.6425 10.5976 15.7702 10.838 15.9616L16.7804 21.0881C17.0571 21.2664 17.3086 21.3567 17.53 21.3567C17.9889 21.3567 18.3149 20.9666 18.4576 20.1653L21.4936 3.45657C21.7416 2.29836 21.2927 1.64286 20.6886 1.64286C20.5344 1.64286 20.3706 1.68557 20.2042 1.77305L2.37751 9.80129C1.16029 10.3718 1.16748 11.164 2.15541 11.5168L5.10197 12.5913C5.10268 12.5913 5.10556 12.5892 5.10628 12.59C5.30825 12.6619 5.53574 12.6369 5.72908 12.4984C5.73268 12.4964 5.73519 12.4972 5.73843 12.4952L13.6225 6.81704C14.2906 6.34636 15.1682 6.5743 15.5897 7.33495C15.948 7.981 15.8596 8.80161 15.4215 9.33512L11.2894 14.0571V14.0579L11.2783 14.0698L11.2775 14.069C11.1485 14.2103 10.9742 14.2982 10.782 14.2982C10.3848 14.2982 10.0632 13.9306 10.0632 13.4768C10.0632 13.2566 10.1397 13.0574 10.2637 12.91L10.263 12.9092L14.3578 8.22866L6.47408 13.9064C5.91129 14.2966 5.25362 14.3664 4.66891 14.1544C4.6646 14.1524 4.66029 14.1544 4.65562 14.1524L1.72668 13.0849C0.183141 12.5334 0.0163892 11.2548 0.00165462 10.8765C-0.021705 10.2391 0.183501 9.05379 1.83197 8.28082L1.8406 8.27671L1.84994 8.27261L19.6446 0.259571C19.9849 0.0874821 20.3361 0 20.6886 0C21.3926 0 22.042 0.357321 22.4704 0.982018C22.9735 1.71268 23.1241 2.71811 22.8966 3.81554ZM10.7812 18.8929C11.1784 18.8929 11.5 19.2604 11.5 19.7143C11.5 20.1681 11.1784 20.5357 10.7812 20.5357C10.3841 20.5357 10.0625 20.1681 10.0625 19.7143C10.0625 19.2604 10.3841 18.8929 10.7812 18.8929Z" fill="white">
                                                </path>
                                            </svg>
                                        </a>
                    ...
                    <ul class="menu_links alter_links m-top2">
                        <li><a href="https://besedaclinic.com.ua/ua/privacy-policy">Політика конфіденційності</a></li>
                        <li><a href="https://besedaclinic.com.ua/ua/public-offer">Публічна оферта</a></li>
                    </ul>
                </div>


                <div class="menu_col">
                    <p class="col_title fw500">Наші послуги</p>
                    <ul class="menu_links">
                                            ...
                                            <li><a href="">- ЛАЗЕРНЕ ВИДАЛЕННЯ РОЗТЯЖЕК / РУБЦІВ</a></li>
                                            <li><a href="">- IPL  LUMENIS M22 ( ЛІКУВАННЯ КУПЕРОЗУ , ПІГМЕНТАЦІЇ , АКНЕ )</a></li>
                                            <li><a href="">- ФРАКЦІЙНЕ  ОМОЛОДЖЕННЯ   RESUR - FX</a></li>
                                            <li><a href="">- КОНТУРНА ПЛАСТИКА</a></li>
                                            <li><a href="">- ЛАЗЕРНА EПІЛЯЦІЯ</a></li>
                                            <li><a href="">- ПЛАЗМОЛІФТИНГ</a></li>
                                            <li><a href="">- ТРИХОЛОГІЯ</a></li>
                                            <li><a href="">- СКЛЕРОТЕРАПІЯ</a></li>
                                            <li><a href="">- ВОЛЮМІЗАЦІЯ ОБЛИЧЧЯ (БЕЗОПЕРАЦІЙНА ПІДТЯЖКА)</a></li>
                                            <li><a href="">- БЛАНШИНГ</a></li>
                                            <li><a href="">- ХІМІЧНА ЛІПОСАКЦІЯ</a></li>
                                            <li><a href="">- ПЕРМАНЕНТНИЙ МАКІЯЖ</a></li>
                                    </ul>
                </div>


                <div class="menu_col">
                    <p class="col_title fw500">Корисні посилання</p>
                    <ul class="menu_links">
                        <li><a href="${countPoin}index.html">- Головна</a></li>
                        <li><a href="${countPoin}about.html">- Про клініку</a></li>
                        <li><a href="${countPoin}angebot/index.html">- Акції</a></li>
                        <li><a href="${countPoin}services/index.html">- Послуги</a></li>
                        <li><a href="${countPoin}team/index.html">- Фахівці</a></li>
                        <li><a href="${countPoin}price.html">- Прайс</a></li>
                        <li><a href="">- Відгуки</a></li>
                        <li><a href="${countPoin}gallery.html">- Галерея</a></li>
                        <li><a href="${countPoin}blog/index.html">- Блог</a></li>
                        <li><a href="${countPoin}faq.html">- FAQ</a></li>
                        <li><a href="${countPoin}contact.html">- Контакти</a></li>
                ...
                <div class="menu_col">
                    ...
                    <div class="contact_item">
                            ...
                            <div class="d-flex align-items-center icon_block ">
                                <svg width="17" height="26" viewBox="0 0 17 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 0V26H16.1484V0H0ZM14.625 1.52344V3.45312H1.52344V1.52344H14.625ZM14.625 4.97656V20.4648H1.52344V4.97656H14.625ZM1.52344 24.4766V21.9883H14.625V24.4766H1.52344Z" fill="black"></path>
                                    <path d="M7.32251 22.4453H8.83071V23.9535H7.32251V22.4453Z" fill="black"></path>
                                </svg>

                                <div class="details flex-column row">
                                    <p class="row">Poggendörper Weg 3-9, 24149 Kiel</p>
                                    <a href="tel:+491605122398" class="fw600 row" >+49 (160) 512 2398</a>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="contact_item">
                        ...
                        <div class="d-flex align-items-center icon_block ">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 0C5.60762 0 0 5.60762 0 12.5C0 19.3924 5.60762 25 12.5 25C19.3924 25 25 19.3924 25 12.5C25 5.60762 19.3924 0 12.5 0ZM12.5 23.4375C6.46896 23.4375 1.56251 18.531 1.56251 12.5C1.56251 6.46896 6.46896 1.56251 12.5 1.56251C18.531 1.56251 23.4375 6.46896 23.4375 12.5C23.4375 18.531 18.531 23.4375 12.5 23.4375Z" fill="black"></path>
                                <path d="M13.2813 4.68753H11.7188V12.8235L16.6351 17.7399L17.7399 16.6351L13.2813 12.1765V4.68753Z" fill="black"></path>
                            </svg>
                            <div class="details  d-flex align-items-center">
                                <p class="hours"><span>Пн - Нд  :    </span> <b> 10:00 - 20:00</b>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="contact_item">
                        ...
                        <div class="d-flex align-items-center icon_block ">
                            ...
                            <div class="details  flex-column row">
                                <p class="row">Інстаграм клініки</p>
                                <a href="https://www.instagram.com/aesthetlc.face/" class="fw600 row" >aesthetlc.face</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contact_item">
                        ...
                        <div class="d-flex align-items-center icon_block ">
                            <a href="https://www.instagram.com/dina.lutsenko/" class="d-flex tg" target="_blank">
                            ...
                            <div class="details  flex-column row">
                                <p class="row">Інстаграм лікаря Діна Луценко</p>
                                <a href="https://www.instagram.com/dina.lutsenko/" class="fw600 row" >dina.lutsenko</a>
                            </div>
                        </div>
                    </div>
...
let related_page_links = document.getElementById("related_page_links");


let related_page_html = `



<div class="related_page_links d-flex">
        <a href="${countPoin}services/index.html" class="fw700 align-items-center d-flex my_btn_outline">
            <svg width="30" height="17" viewBox="0 0 30 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.11424 15.4061L2.59516 8.88707L29.7412 8.89186V7.52952L2.59516 7.53432L8.63454 1.49494L7.67515 0.535547L0.479698 7.731C0.352475 7.85822 0.281001 8.03077 0.281001 8.21069C0.281001 8.39062 0.352475 8.56317 0.479698 8.69039L8.15484 16.3655L9.11424 15.4061Z" fill="black"></path>
            </svg>
            Послуги        </a>
        <a href="${countPoin}price.html"  class="fw700 align-items-center d-flex my_btn_outline">
            Прайс            <svg width="31" height="16" viewBox="0 0 31 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21.3081 1.01573L27.8272 7.53481L0.681169 7.53001V8.89235L27.8272 8.88755L21.7878 14.9269L22.7472 15.8863L29.9427 8.69088C30.0699 8.56365 30.1414 8.3911 30.1414 8.21118C30.1414 8.03126 30.0699 7.85871 29.9427 7.73149L22.2675 0.0563384L21.3081 1.01573Z" fill="black"></path>
            </svg>
        </a>
    </div>
`

...
function header_refresh(header_menuArr, newLang, oldLang) {
    ...
    <div class="blur ">
                ...
                <div class="my_container">
                    ...
                    <div class="header_top_row d-flex align-items-center justify-content-between m-0 ">
                            ...
                            <div class="logo_block d-flex justify-content-center m-0">
                            ...
                            <div class="d-flex align-items-center ">
                                ...
                                <div class="icon_block d-flex align-items-center justify-content-end  ">
                            ...
                            <div class="d-flex align-items-center  w-100 ">
                                    ...
                                    <div class="icon_block d-flex align-items-center justify-content-between w-100">
                                            ...
                                            <div class="d-flex row hours details">
                            ...
                            <div class="d-flex align-items-center w-100">
                                    ...
                                    <div class="icon_block d-flex justify-content-between w-100">
                                    ...
                                    <div class="details d-flex m-0 my_btn icon_block  d-flex justify-content-between w-100">
                                            ...
                                            <div class="btn_text d-flex text-center">

                                                <p class="m-1">Записатися ONLINE
                        ...
                        <div class="navbar d-flex">
                            ...
                            <ul class="d-flex"> 
                                ...
                                <li id="leistungen">
                                    ...
                                    <ul id="leistungen_header_menu" class="hide">
    ...
    leistungen.addEventListener('mouseover', function(e) {

        leistungen_header_menu.classList.add('show');
    });


    leistungen.addEventListener('mouseout', function(e) {

        leistungen_header_menu.classList.remove('show');
    });
